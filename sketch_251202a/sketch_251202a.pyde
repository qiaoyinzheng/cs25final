...
class Ship:
    ...
    def update(self):
        ...
        if self.key_handler[UP]:
            ...
            self.velocity_x += cos(radians(self.angle)) * 0.1    # eg. facing right ~ 0 degrees ~ cos is 1, indicating +1 movement towards X....
            self.velocity_y += sin(radians(self.angle)) * 0.1            
...
class Wave:
    ...
    def __init__(self, in_wave_number):    
        ...
        self.asteroids_num = self.wave_number*10
