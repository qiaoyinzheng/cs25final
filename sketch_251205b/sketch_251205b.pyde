...
class Game:
    ...
    def display(self):
        ...
        if(self.game_state == 'INTRO'):
            ...
            text("Press ENTER to start the game", RES_WIDTH / 2, RES_HEIGHT/2)
            ...
            if(self.waves[self.wave].ending_detection() == True):
                ...
                if(self.wave+1 > 10):
                    ...
                    textSize(24)
                    textAlign(RIGHT, TOP)
                    text("You have progressed through all 10 waves"+str(self.health), RES_WIDTH / 2 -80, 110) # need to rework on this condition
